...
/* --- Math: pow (linked from ntdll on Wine 4-7, not on Win98) --- */
...
/* --- sprintf (linked from ntdll on Wine 4-5, not on Win98) ---
   Forwards to msvcrt's vsprintf. */
extern int __cdecl vsprintf(char *, const char *, __builtin_va_list);
